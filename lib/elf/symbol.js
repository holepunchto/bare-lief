...
module.exports = exports = class ELFSymbol {
  ...
  set name(value) {
    return binding.elfSymbolSetName(this._handle, value)
  }
  ...
  set value(value) {
    return binding.elfSymbolSetValue(this._handle, value)
  }
  ...
  set binding(value) {
    return binding.elfSymbolSetBinding(this._handle, value)
  }
  ...
  set sectionIndex(value) {
    return binding.elfSymbolSetSectionIndex(this._handle, value)
  }
